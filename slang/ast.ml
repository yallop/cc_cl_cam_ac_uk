...
let rec string_of_expr = function
    | Unit _            -> "Unit"
    | Var(l, x)            -> mk_con "Var" [x]
    | Integer(l, n)        -> mk_con "Integer" [string_of_int n]
    | Boolean(l, b)        -> mk_con "Boolean" [string_of_bool b]
    ...
    | Fst(l, e)            -> mk_con "Fst" [string_of_expr e]
    | Snd(l, e)            -> mk_con "Snd" [string_of_expr e]
    | Inl(l, e)            -> mk_con "Inl" [string_of_expr e]
    | Inr(l, e)            -> mk_con "Inr" [string_of_expr e]
    ...
    | Ref(l, e)            -> mk_con "Ref" [string_of_expr e]
    | Deref(l, e)          -> mk_con "Deref" [string_of_expr e]
